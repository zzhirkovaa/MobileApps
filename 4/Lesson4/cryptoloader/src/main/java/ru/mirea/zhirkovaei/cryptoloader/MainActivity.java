...
import ru.mirea.zhirkovaei.cryptoloader.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.buttonEncrypt.setOnClickListener(v -> {
            ...
            byte[] shifr = encryptMsg(phrase, key);

            Bundle bundle = new Bundle();
            bundle.putByteArray(MyLoader.ARG_WORD, shifr);
    ...
    public Loader<String> onCreateLoader(int id, @Nullable Bundle args) {
        if (id == LoaderID) {
            Log.d("TEST", "onCreateLoader вызван");
